    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>Bebidas </b>Walley</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="#" target="_blank" class="">Ezequiel H Miceli</a>
                      <a href="#" target="_blank" class="">Ver Waipara  Max</a>
                  </li>
