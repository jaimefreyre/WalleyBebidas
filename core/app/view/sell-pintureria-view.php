<div class="row">
	...
	<div class="col-md-12">
	<h1>Venta Pintureria</h1>
	<p><b>Buscar producto por nombre o por codigo (solo se incluyen stock sucursal <?php print_r(UserData::getById($_SESSION["user_id"])->username) ?> ):</b></p>
		<form id="searchp">
		<div class="row">
			<div class="col-md-6">
...
$(document).ready(function(){
	$("#searchp").on("submit",function(e){
		...
		$.get("./?action=searchproduct-pintureria",$("#searchp").serialize(),function(data){
...
<tr >
	...
	<td><b>$ <?php echo number_format($product->user_id); ?></b></td>
	<td><b>$ <?php  $pt = $product->user_id*$p["q"]; $total +=$pt; echo number_format($pt); ?></b></td>


	<td style="width:30px;"><a href="index.php?view=clearcart-pintureria&product_id=<?php echo $product->id; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a></td>
</tr>

<?php endforeach; ?>
</table>
<form method="post" class="form-horizontal" id="processsell" action="index.php?view=processsell-pintureria">
<h2>Resumen</h2>
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-lg-10">
      ...
      <input type="text" name="total" value="<?php echo $total; ?>" class="form-control" placeholder="Total">
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
		<a href="index.php?view=clearcart-pintureria" class="btn btn-lg btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
