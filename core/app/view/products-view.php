		...
		<div class="btn-group  pull-right">
			...
			<div class="btn-group pull-right">
			  ...
			  <ul class="dropdown-menu" role="menu">
			    ...
			    <li><a href="report/products-excel.php">Excel (.xlsx)</a></li>
			  </ul>
			</div>
			<div class="btn-group pull-right">
			  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
			    <i class="fa fa-download"></i> Descargar Lista precios<span class="caret"></span>
			  </button>
			  <ul class="dropdown-menu" role="menu">
			    <li><a href="report/products-lista-word.php">Word (.docx)</a></li>
			    <li><a href="report/products-lista-excel.php">Excel (.xlsx)</a></li>
			  </ul>
			</div>
		</div>
				...
				<div class="clearfix"></div>
					...
					<table class="table table-bordered table-hover">
						...
						<tr>
							...
							<td>$ <?php echo number_format($product->user_id,2,'.',','); ?></td>
