<div class="row">
	...
	<small>Desde esta sesion se abastece el stock de la sucursal <?php echo UserData::getById($_SESSION["user_id"])->username; ?></small>
	<hr>
...
// $q= OperationData::getById($product->id);
	?>
