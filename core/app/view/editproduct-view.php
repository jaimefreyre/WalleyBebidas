...
<?php endif;?>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Precio de Reventa*</label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Precio Pintureria*</label>
    <div class="col-md-8">
      <input type="text" name="user_id" class="form-control" id="user_id" value="<?php echo $product->user_id; ?>" placeholder="Precio de Pintureria">
    </div>
  </div>
  <div class="form-group">
