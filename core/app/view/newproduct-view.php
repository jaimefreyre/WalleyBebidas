...
<div class="row">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Precio de Reventa*</label>
    <div class="col-md-6">
      <input type="text" name="price_out" required class="form-control" id="price_out" placeholder="Precio de salida revendedores">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Precio de Pintureria*</label>
    <div class="col-md-6">
      <input type="text" name="pintureria" required class="form-control" id="pintureria" placeholder="Precio de salida Pinturerias">
    </div>
  </div>
  <div class="form-group">
