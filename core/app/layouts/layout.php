...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Gestion de Negocios | Dashboard</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <link rel="manifest" href="plugins/a2hs/manifest.webmanifest">
    ...
    <script src="plugins/a2hs/index.js" defer></script>
  ...
  <body class="<?php if(isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])):?>  skin-blue-light sidebar-mini <?php else:?>login-page<?php endif; ?>" >
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>Pintureria </b>Walter</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="">
                    <?php if(isset($_SESSION["user_id"]) )
                      { echo UserData::getById($_SESSION["user_id"])->username;}?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="" target="_blank" class="">Soporte</a>
                      <!-- <a href="http://evilnapsis.com/product/Waipara -max/" target="_blank" class="">Ver Waipara  Max</a> -->
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="./?view=sell-pintureria">Local</a></li>
                <li><a href="./?view=sell-reventa">Revendedores</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="./?view=inventary">Inventario Total</a></li>
                <li><a href="./?view=inventaryuser">Inventario Sucursal</a></li>
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2019 <a href="" target="_blank">Ezequiel H Miceli</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">Pintureria <b>Walter</b></a>
      </div><!-- /.login-logo -->
